...
public class CreateEnemy {
        public static ArrayList<Enemy> Bestiary(){
            ...
            enemies.add(new Enemy(1,"C", 10, 10,"Jabali Salvaje", 4, 0,15, 10,"Carne Jabali","PRADO", false));
            ...
            enemies.add(new Enemy(10,"S", 10, 10,"Halcon real", 4, 0,15,50,"Cabeza de Halcon Real","PRADO", true));

            //Bosque

            enemies.add(new Enemy(4,"C",10,10,"Ciervo Fantasma", 4, 0,15,10,"Carne Jabali","BOSQUE",false));
            ...
            enemies.add(new Enemy(11,"S", 10, 10,"Hidra de Hojas", 4, 0,15,50,"Cabeza de Halcon Real","BOSQUE", true));
            ...
            enemies.add(new Enemy(12,"S", 10,10, "Golem de Cristal", 4, 0,15,50,"Cabeza de Halcon Real","CUEVA", true));
